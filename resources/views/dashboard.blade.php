                            ...
                            <div class="nk-content-body">
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        ...
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Nos Applications</h3>
                                ...
                                <div class="nk-block">
                                    <div class="row g-gs">
                                        ...
                                        <div class="col-xxl-3 col-lg-4 col-sm-6 {{ hasCrm(Auth::user()->id) ? '' : 'disable'}}">
                                            <div class="card card-bordered product-card">
                                                <div class="product-thumb hover-overlay ripple">
                                                    <a href="#">
                                                        <img class="card-img-top img-fluid" src="{{asset('demo/images/test7.jpg')}}" alt="">
                                                    </a>
                                                ...
                                                <div class="card-inner text-center">
                                                    <ul class="product-tags">
                                                        <li><a href="#">Commandez vos cachets pré-encrés en express</a></li>
                                                    </ul>
                                                    <h5 class="product-title"><a href="#">CRM</a></h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xxl-3 col-lg-4 col-sm-6 {{ hasCachet(Auth::user()->id) ? '' : 'disable'}}">
                                            <div class="card card-bordered product-card">
                                                <div class="product-thumb hover-overlay ripple">
                                                    <a href="#">
                                                        <img class="card-img-top" src="{{asset('demo/images/test3.jpg')}}" alt="">
                                                    </a>
                                                </div>
                                                <div class="card-inner text-center">
                                                    <ul class="product-tags">
                                                    ...
                                                    <h5 class="product-title"><a href="#">Cachet Express</a></h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xxl-3 col-lg-4 col-sm-6 disable">
                                            <div class="card card-bordered product-card">
                                                <div class="product-thumb hover-overlay ripple">
                                                    <a href="#">
                                                        <img class="card-img-top" src="{{asset('demo/images/test6.jpg')}}" alt="">
                                                    </a>
                                                </div>
                                                <div class="card-inner text-center ">
                                                    <ul class="product-tags">
                                        ...
                                        <div class="col-xxl-3 col-lg-4 col-sm-6 disable">
                                            <div class="card card-bordered product-card">
                                                <div class="product-thumb hover-overlay ripple">
                                                    <a href="#">
                                                        <img class="card-img-top" src="{{asset('demo/images/test5.jpg')}}" alt="">
                                                    </a>
                                                </div>
                                                <div class="card-inner text-center">
                                                    <ul class="product-tags">
                                        ...
                                        <div class="col-xxl-3 col-lg-4 col-sm-6 disable">
                                            <div class="card card-bordered product-card">
                                                <div class="product-thumb hover-overlay ripple">
                                                    <a href="#">
                                                        <img class="card-img-top" src="{{asset('demo/images/test7.jpg')}}" alt="">
                                                    </a>
                                                    <ul class="product-badges">
                                                        <li><span class="badge bg-danger">Hot</span></li>
                                                    </ul>
