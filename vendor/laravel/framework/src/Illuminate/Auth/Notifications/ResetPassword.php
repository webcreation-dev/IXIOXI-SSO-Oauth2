...
class ResetPassword extends Notification
{
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ...
            ->line(Lang::get('Vous recevez cet e-mail car nous avons reçu une demande de réinitialisation du mot de passe de votre compte.'))
            ...
            ->line(Lang::get("Si vous n'avez pas demandé de réinitialisation du mot de passe, aucune action supplémentaire n'est requise."));
    }
